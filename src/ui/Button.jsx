const Button = ({ children, ...props }) => {
  return (
    <button
      {...props}
      className="group relative flex h-12 w-[170px]  items-center justify-between border-2 dark:border-purple-700 border-purple-300 rounded-full  bg-linear-to-r dark:from-purple-900 dark:to-purple-700    bg-purple-300 font-medium dark:text-neutral-200 text-black"
    >
